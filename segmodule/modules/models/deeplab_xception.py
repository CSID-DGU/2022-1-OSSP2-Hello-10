...
class Xception(nn.Module):
    ...
    def _load_xception_pretrained(self):
        pretrain_dict = torch.load("C:/Users/teala/Desktop/Watch_Out/xception-b5690688.pth")
        model_dict = {}
...
if __name__ == "__main__":
    model = DeepLabv3_plus(nInputChannels=3, n_classes=21,
                           os=16, pretrained=True, _print=True)
    model.eval()
